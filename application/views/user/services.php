        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate pb-0 text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo base_url() ?>Main_Front_User">Home <i class="fa fa-chevron-right"></i></a></span> <span>Services<i class="fa fa-chevron-right"></i></span></p>
            ...
            <div class="row">
                <div class="col-md-3 d-flex align-items-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center px-3 pb-4">
                        ...
                        <div class="media-body py-md-4">
                            <h3>Development</h3>
                            <p>Website kami akan membantu dalam perkembangan kos pemilik, terutama dalam hal pemasaran.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex align-items-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center px-3 pb-4">
                        ...
                        <div class="media-body py-md-4">
                            ...
                            <p>Tentunya akan lebih mudah dalam menarik audiens atau calon pembeli, dengan wadah media yang telah kami sediakan.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex align-items-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center px-3 pb-4">
                        ...
                        <div class="media-body py-md-4">
                            <h3>Brokerage</h3>
                            <p>Sebagai perantara antara pemilik kos dan juga calon penghuni kos.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex align-items-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center px-3 pb-4">
                        ...
                        <div class="media-body py-md-4">
                            ...
                            <p>Memanage data kos yang masuk, mulai dari upload ke website, perantara antara pemilik kos dan juga pembeli, hingga deal.</p>
                        </div>
                    </div>
                </div>
            </div>
